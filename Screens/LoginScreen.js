  ...
  return (
    <View style={{ flex: 1, flexDirection: "column" }}>
      ...
      >
        ...
        <Center>
          <TextMedium Color={Colors.Purple} FontSize={Constants.FontMedium}>
            {language == "Tr" && ContentTr.LoginSubTitle}
          </TextMedium>
        </Center>
        ...
        <View style={{ width: 270, alignSelf: "center", marginTop: 20 }}>
          <TouchableOpacity
            onPress={() => Alert.alert("Parolamı Unuttum")}
            style={{ right: 0, position: "absolute" }}
          >
            <TextMedium Color={Colors.Gray} FontSize={Constants.FontMedium}>
              {language == "Tr" && ContentTr.ForgotPasswordQuestion}
            </TextMedium>
          </TouchableOpacity>
        </View>
          ...
          >
            ...
            >
              <View style={{ marginRight: 20 }}>
                ...
                >
                  {language == "Tr" && ContentTr.LoginButtonTitle}
                </TextMedium>
              </View>
              <Image
        ...
        >
          <View style={{ flexDirection: "row", alignSelf: "center" }}>
            <TextMedium Color={Colors.Gray} FontSize={Constants.FontMedium}>
              {language == "Tr" && ContentTr.NoAccounts}
            </TextMedium>
            <TouchableOpacity
              style={{ marginLeft: 5 }}
            ...
            >
              <TextMedium Color={Colors.Purple} FontSize={Constants.FontMedium}>
                {language == "Tr" && ContentTr.BecomeaMember}
              </TextMedium>
            </TouchableOpacity>
          </View>
        </View>
